...
public class SuicideCommand implements CommandExecutor, TabCompleter, Listener {
    ...
    public SuicideCommand(@NotNull JavaPlugin plugin, @NotNull ConfigManager configManager) {
        this.plugin = plugin;
    ...
    private void executeSuicide(@NotNull Player player) {
        ...
        FoliaScheduler.runGlobalTask(plugin, () -> Bukkit.broadcastMessage(formattedMsg));
    }
